...
setRedirect(false);
            ...
            <div className="container flex flex-col  h-screen w-screen items-center justify-center ">
                <div className="container">
                    ...
                    <div className="wrap-top">
                        ...
                        <div  className="loading loading--center loading--glitch loading--animation absolute text-[#eb0005] font-Rubik left-1/4 lg:left-[42%] text-2xl"
                             data-title="Loading...">
                            Loading...
                        </div>
    ...
    return (
        <div className="  container m-0 flex flex-col  min-h-screen w-full  items-center justify-center  ">
                ...
                <div className="gli re relative -top-20 lg:-top-10 flex flex-col items-center lg:mt-11 mb-3 font-medium font-Rubik text-[#ff0130] text-5xl " data-text="BLACKOUT">BLACKOUT</div>



            {show? <p className="flex flex-col mb-11 lg:mb-11  items-center font-Rubik  text-[#ff0130] text-2xl ">{tem.question}</p>:<p></p>}
              <div className=" flex flex-col h-full w-full items-center gap-6 ">
                ...
                <div className="flex flex-col h-1/2 w-full items-center justify-center">
                    ...
                    <img alt="img" src={img} className="flex flex-col   max-h-56 max-w-3xl "/>
                </div>
